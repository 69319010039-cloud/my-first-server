...
// ---------------------------------------------------------
// เสนทางที่ 1: (GET /) เมื่อเปิดหน้าเว็บหลัก ใหแสดงฟอรมและตารางขอมูล
// ---------------------------------------------------------
...
`;
// นําข้อมูลจากฐานข้อมูลมาวนลูปแสดงในตาราง
...
confirm('ยืนยันการลบข้อมูลนี้?')">ลบ</button>
</form>
</td>
</tr>
`;
